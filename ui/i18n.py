# ui/i18n.py
"""
yt-dlp Downloader Pro - Localization & Multi-language Support
Contains translation dictionaries for English (en), Turkish (tr), and Spanish (es).
"""
...
TRANSLATIONS = {
    "en": {
        ...
        "lbl_schedule_desc": "Deferred background download using local schedule countdown timer.",
        "lbl_duplicate_title": "Duplicate Video Detected",
        "lbl_duplicate_body": "You have already downloaded: {title} ({format}). Do you want to download it again?",
    ...
    "tr": {
        ...
        "tab_scheduling": "Zamanlayıcı ⏰",
        "lbl_schedule_enable": "İndirmeyi Zamanla",
        "lbl_schedule_time": "Başlangıç Saati (SS:DD):",
        "lbl_schedule_desc": "Yerel geri sayım sayacı kullanan zamanlanmış arka plan indirmesi.",
        "lbl_duplicate_title": "Kopya Video Tespit Edildi",
        "lbl_duplicate_body": "Bu videoyu zaten indirdiniz: {title} ({format}). Tekrar indirmek istiyor musunuz?",
    ...
    "es": {
        ...
        "lbl_schedule_desc": "Descarga programada utilizando un temporizador de cuenta regresiva local.",
        "lbl_duplicate_title": "Video Duplicado Detectado",
        "lbl_duplicate_body": "Ya has descargado: {title} ({format}). ¿Quieres descargarlo de nuevo?",
